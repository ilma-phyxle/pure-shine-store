...
const testimonials = [
  ...
  },
  {
    ...
    rating: 5,
    text: "Fantastic range and competitive pricing. We've reduced our cleaning budget by 20% since switching to GRAPC. Their eco-friendly range is excellent.",
    avatar: "EW",
    timeAgo: "5 days ago",
  },
  {
    ...
    role: "Gym Owner",
    rating: 5,
    text: "The disinfectants and sanitisers from GRAPC are top quality. Our gym has never been cleaner. Fast delivery and great support team.",
    avatar: "MP",
