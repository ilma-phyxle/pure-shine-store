          ...
          {items.length === 0 ? (
            ...
            <>
              <div className="flex-1 overflow-y-auto pr-2 min-h-0 space-y-4">
                {items.map((item) => (
                  <div key={item.variantId} className="flex gap-3 p-3 rounded-lg border bg-card">
              ...
              <div className="flex-shrink-0 space-y-3 pt-4 border-t mt-4">
                ...
                <Button onClick={handleCheckout} className="w-full bg-secondary hover:bg-secondary/90" size="lg" disabled={isLoading || isSyncing}>
