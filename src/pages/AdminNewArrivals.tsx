        ...
        <AdminLayout>
            <div className="space-y-8 animate-in fade-in duration-500">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
                    <div>
                        <h1 className="text-3xl font-display font-bold tracking-tight text-blue-900 mb-1">New Arrivals</h1>
                    ...
                    <div className="p-6 border-b border-slate-200 bg-slate-50/60">
                        <div className="relative">
                            ...
                            <Input 
                                ...
                                className="pl-11 bg-white border-slate-200 h-12 rounded-xl text-slate-900 placeholder:text-slate-500 focus:ring-primary/20"
                                value={searchTerm}
                        ...
                        {loading ? (
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left">
                                    <thead>
                                        <tr className="border-b border-slate-200 text-[10px] font-black uppercase tracking-[0.2em] text-slate-500 bg-slate-50">
                                            ...
                                            <tr key={p.id} className="group hover:bg-slate-50/60 transition-colors">
                                                <td className="px-8 py-5">
                                                    <div className="flex items-center gap-4">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div className="text-[10px] text-slate-500 font-mono mt-0.5">${p.price} • {p.category?.name}</div>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td className="px-8 py-5 text-center">
                                                    {p.is_new_arrival ? (
                                                        ...
                                                        <Badge variant="outline" className="text-slate-700 border-slate-200 px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest">
                                                            Inactive
                                                        </Badge>
                                                    )}
                                                </td>
