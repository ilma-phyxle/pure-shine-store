...
export const ChatbotWidget = () => {
  ...
  return (
    <>
      ...
      {/* Chat window */}
      {open && (
        <div className="fixed bottom-20 sm:bottom-24 right-2 sm:right-6 z-50 w-[calc(100vw-1rem)] sm:w-[340px] max-h-[70vh] sm:max-h-[480px] rounded-2xl border bg-card shadow-2xl flex flex-col overflow-hidden animate-in slide-in-from-bottom-4 fade-in duration-300">
          {/* Header */}
